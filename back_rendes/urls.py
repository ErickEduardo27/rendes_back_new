...
router.register(r'unidadesActuales', viewsAsis.unidadesActualesViewSet,basename = 'usuario_ipress')
router.register(r'unidadesActualesPaginacion', viewsAsis.unidadesActualesPagViewSet)
router.register(r'morbilidadesHospitalarias', viewsAsis.morbilidadesHospitalariasViewSet,basename='unidadesactuales-paginadas')
